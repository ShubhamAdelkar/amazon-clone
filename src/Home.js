    ...
    return (
        <div className='home'>
            ...
            <div className='home__row '>
                <Product id='6735678' title='Sony WH-CH720N, Wireless Over-Ear Active Noise Cancellation Headphones with Mic, up to 35 Hours Playtime, Multi-Point Connection, App Support, AUX & Voice Assistant Support for Mobile Phones (Blue)' seller='by Sony (imbachhu)' price={97.99} image='https://m.media-amazon.com/images/I/61zWFqX+krL._AC_UL480_FMwebp_QL65_.jpg' rating={5} list='$112' save='Save $3' />

                <Product id='7683678' title='MageGee Portable 60% Mechanical Gaming Keyboard for Windows Laptop PC Mac' seller='by MageGee (imbachhu)' price={27.20} image={'https://m.media-amazon.com/images/I/71NMtTQkYUL._AC_UY327_FMwebp_QL65_.jpg'} rating={4} list='$47' save='Save $5' />
            </div>

            <div className='home__row '>
                <Product id='8376549' title='Atomic Habits: the life-changing #1 bestseller' seller='by James Clear (imbachhu)' price={10} image='https://5.imimg.com/data5/SELLER/Default/2022/2/UA/RV/VK/147304712/whatsapp-image-2022-02-20-at-5-05-40-pm-4--500x500.jpeg' rating={5} list='$15' save='Save $1' />

                <Product id='9273652' title='OnePlus Nord Watch with 1.78 AMOLED Display, 60 Hz Refresh Rate, 10 Days Battery [Midnight Black]' seller='by One Plus (imbachhu)' price={47} image='https://m.media-amazon.com/images/I/510+3Km7MtL._AC_UL480_FMwebp_QL65_.jpg' rating={4} list='$65' save='Save $4' />
